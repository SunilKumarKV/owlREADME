...
import useReadmeStore, { createDefaultReadmeData, GitHubStatsConfig, TechStackConfig, SocialLinksConfig, AchievementsConfig, HeaderConfig, SectionOrderConfig, SupportConfig, QuotesConfig, CustomMarkdownConfig, StandaloneVisitorConfig, AnimatedComponentsConfig } from './readme-store';
    ...
    (set, get) => ({
      ...
      createWorkspace: (name, type) => {
        ...
        const newWorkspace: Workspace = {
          ...
          readmeData: createDefaultReadmeData(),
          roadmapData: {
            title: '',
            steps: [],
            template: '',
